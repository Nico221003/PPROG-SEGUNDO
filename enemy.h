...
/**
 * @brief It gets the object of the enemy
 * @author Alejandra Palma
 *
 * @param enemy pointer to the enemy
 * @return the object of the enemy
 */
Id enemy_get_object(Enemy *enemy);

/**
 * @brief It sets the object of the enemy
 * @author Alejandra Palma
 *
 * @param enemy pointer to the enemy
 * @param id id of the object to be setted in the enemy struct
 * @return OK if everything went well or ERROR in case of error
 */
STATUS enemy_set_object(Enemy *enemy, Id id);
