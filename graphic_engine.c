...
void graphic_engine_paint_game(Graphic_engine *ge, Game *game) {
  ...
  char obj = '\0', dirleft= '\0', dirright= '\0';
  char str[255];
  ...
  if ((id_act = game_get_player_location(game)) != NO_ID) {
    ...
    if (id_back != NO_ID) {
      ...
      sprintf(str, " %c|     %c     |%c", dirleft, obj, dirright);
      screen_area_puts(ge->map, str);
      sprintf(str, "  +-----------+");
      screen_area_puts(ge->map, str);
      sprintf(str, "        ^");
  ...
  if ((obj_loc = game_get_object_location(game)) != NO_ID) {
    ...
    screen_area_puts(ge->descript, str);
    sprintf(str, "  Enemy location:%d", (int)game_get_enemy_location(game));
    screen_area_puts(ge->descript, str);
  ...
  sprintf(str, "next or n, back or b, take or t, drop or d, exit or e, left or l, right or r, attack or a");
  screen_area_puts(ge->help, str);
